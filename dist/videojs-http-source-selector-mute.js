...
(function (global, factory) {
  ...
  var onPlayerReady = function onPlayerReady(player, options) {
    ...
    player.on(["loadedmetadata"], function (e) {
      var qualityLevels = player.qualityLevels(); // videojs.log('loadmetadata event');
      ...
      if (player.videojs_http_source_selector_mute_initialized == "undefined" || player.videojs_http_source_selector_mute_initialized == true) ; else {
        ...
        var controlBar = player.controlBar,
            volumePanel = controlBar.getChild("volumePanel").el();
        controlBar.el().insertBefore(controlBar.addChild("SourceMenuButton").el(), volumePanel);
      }
    });
  };
  /**
